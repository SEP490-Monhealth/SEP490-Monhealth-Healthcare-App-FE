            ...
            <div className="flex gap-6">
              <div className="flex-shrink-0">
                <Avatar className="h-full w-48 rounded-xl">
                  <AvatarImage
                    src={transactionData.member.avatarUrl}
                    alt={getInitials(transactionData.member.fullName || "")}
                  />
                  <AvatarFallback className="rounded-xl">
                    {getInitials(transactionData.member.fullName || "")}
                  </AvatarFallback>
                </Avatar>
              </div>
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="fullName"
                    type="text"
                    value={transactionData.member.fullName}
                    readOnly
                  />
                </div>
